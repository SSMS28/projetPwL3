...
/* post/new.html.twig */
class __TwigTemplate_2a9353f248b193ad38b3d4283fe306ba extends Template
{
    private $source;
    private $macros = [];
...
{% block body %}
    ...
    {{form_widget(form)}}
        <button class=\"btn btn-success mt-5\">Add</button>
    {{ form_end(form)}}
{%endblock%}", "post/new.html.twig", "C:\\Users\\KOMENAN\\Downloads\\projetPwL3-main\\projetPwL3-main\\blog\\templates\\post\\new.html.twig");
    }
}
