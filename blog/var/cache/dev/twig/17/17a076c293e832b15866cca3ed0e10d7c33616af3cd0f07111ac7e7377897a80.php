...
class __TwigTemplate_e13915c6a63898e8e2f563673c195aca820f37d4ac7b5552b7cc0b7980c8a47e extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <h2>";
        ...
        <img src=";
         ...
         <p>";
            // line 34
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["post"], "descriptif", [], "any", false, false, false, 34), "html", null, true);
            echo "</p>
         <a href=\"";
            // line 35
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("post_show", ["id" => twig_get_attribute($this->env, $this->source, $context["post"], "id", [], "any", false, false, false, 35)]), "html", null, true);
            echo "\">Read more</a>
        </div>
    </article>
</section>
...
";
    ...
    {
        return array (  153 => 40,  142 => 35,  138 => 34,  133 => 32,  124 => 26,  120 => 25,  116 => 24,  111 => 22,  107 => 20,  103 => 19,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
