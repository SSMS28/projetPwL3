...
/* post/show.html.twig */
class __TwigTemplate_9cd26036c8d96bdadb18e0b24161d5377b173dc0b90c868b557e5af6c9b7913b extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <h2>";
        ...
        echo " ";
        echo (((0 >= twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 29, $this->source); })()), "comments", [], "any", false, false, false, 29)), 1))) ? ("commentaire") : ("commentaires"));
        echo "
        </div>
        <div class=\"content\">
...
<h2 class=\"mt-5\"> ";
        // line 39
        echo twig_escape_filter($this->env, twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 39, $this->source); })()), "comments", [], "any", false, false, false, 39)), "html", null, true);
        echo " ";
        echo (((0 >= twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 39, $this->source); })()), "comments", [], "any", false, false, false, 39)), 1))) ? ("commentaire") : ("commentaires"));
        echo "</h2>
<section class=\"mt-5\">
    ";
        // line 41
...
";
    ...
    {
        return array (  213 => 58,  208 => 56,  204 => 55,  197 => 50,  188 => 47,  178 => 44,  174 => 42,  170 => 41,  163 => 39,  156 => 35,  152 => 34,  142 => 29,  138 => 28,  134 => 27,  130 => 26,  125 => 24,  121 => 22,  112 => 19,  109 => 18,  105 => 17,  91 => 5,  81 => 4,  62 => 3,  51 => 1,  49 => 2,  36 => 1,);
    }
