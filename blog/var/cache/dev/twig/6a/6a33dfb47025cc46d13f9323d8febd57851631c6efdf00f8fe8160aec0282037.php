...
/* post/new.html.twig */
class __TwigTemplate_cdbdcb1105c1ce2dcda87e89dbbc209153646aaee0c0f4f594fbcd3e3f79d98c extends Template
{
    private $source;
    private $macros = [];
...
{% block body %}
    ...
    {{form_widget(form)}}
        <button class=\"btn btn-success mt-5\">Add</button>
    {{ form_end(form)}}
{%endblock%}", "post/new.html.twig", "/Users/magalseck/downloads/blog/templates/post/new.html.twig");
    }
}
